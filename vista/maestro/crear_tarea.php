   ...
   <div class="container">
       <div class="row d-flex justify-content-center">
           <table class="table table-striped table-hover">
                ...
                <tbody id="tareas">
                    <tr>
                        <td><input type="text" class="form-control" id="nombre_tarea"></td>
                        <td><select id="grupos" class="form-control"></select></td>
                        <td><select id="materias" class="form-control"></select></td>
                        <td><button class="btn btn-primary" onclick="agregar_tarea()">Guardar</button></td>
                    </tr>
                </tbody>
            </table>
       </div>
   </div>
    <script src="assets/js/maestro/crear_tarea.js"></script>
